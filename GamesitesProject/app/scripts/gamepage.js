jQuery(document).ready(function ($) {
    ...
    if (localStorage.gsUsername === undefined) {
        ...
        // set username
        var $h2 = $("#contentRight h2");
        $h2.text(localStorage.gsUsername);
        
        if (localStorage.gsUsername.length === 20) {
            $h2.css("font-size", '21px');
        }
        else if (localStorage.gsUsername.length > 17) {
            $h2.css("font-size", '23px');
        }
        else if (localStorage.gsUsername.length > 15) {
